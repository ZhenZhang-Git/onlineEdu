...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    public PageResult<MediaFiles> queryMediaFiels(Long companyId, PageParams pageParams, QueryMediaParamsDto queryMediaParamsDto) {
        ...
        queryWrapper.like(queryMediaParamsDto.getFilename() != null, MediaFiles::getFilename, queryMediaParamsDto.getFilename())
                .like(queryMediaParamsDto.getFileType() != null, MediaFiles::getFileType, queryMediaParamsDto.getFileType())
                .like(queryMediaParamsDto.getAuditStatus() != null, MediaFiles::getAuditStatus, queryMediaParamsDto.getAuditStatus());
        //分页对象
    ...
    public RestResponse mergechunks(Long companyId, String fileMd5, int chunkTotal, UploadFileParamsDto uploadFileParamsDto) {
        ...
        try {
            try {
                ...
                OnlineEduException.cast("创建临时合并文件出错");
            }
            ...
            try (RandomAccessFile raf_write = new RandomAccessFile(tempMergeFile, "rw")) {
                ...
                OnlineEduException.cast("合并文件过程出错");
            }
    ...
    public MediaFiles getFileById(String id) {
        ...
        if (mediaFiles == null) {
            OnlineEduException.cast("文件不存在");
        }
        String url = mediaFiles.getUrl();
        if (StringUtils.isEmpty(url)) {
            OnlineEduException.cast("文件还没有处理，请稍后预览");
        }
    ...
    private File[] checkChunkStatus(String fileMd5, int chunkTotal) {
        ...
        for (int i = 0; i < chunkTotal; i++) {
            ...
            try {
                ...
                e.printStackTrace();
                OnlineEduException.cast("创建分块临时文件出错" + e.getMessage());
            }
            //下载分块文件
    ...
    public File downloadFileFromMinIO(File file, String bucket, String objectName) {
        ...
        try (InputStream inputStream = minioClient.getObject(getObjectArgs); FileOutputStream outputStream = new FileOutputStream(file);) {
            IOUtils.copy(inputStream, outputStream);
            return file;
        } catch (Exception e) {
            e.printStackTrace();
            OnlineEduException.cast("查询分块文件出错");
        }
        return null;
    }
    ...
    public void addMediaFilesToMinIO(String filePath, String bucket, String objectName) {
        try {
            ...
            OnlineEduException.cast("文件上传到文件系统失败");
        }
    }
    ...
    private void addMediaFilesToMinIO(byte[] bytes, String bucket, String objectName) {
        ...
        try {
            ...
            OnlineEduException.cast("上传文件到文件系统出错");
        }
    }
